...
from config_manager import base_configuration, config_field
    ...
    def test_validate_field(self):
        valid_test_fields = [
            ...
            (
                ...
                config_field.Field(
                    ...
                    key="hello",
                    types=[int, str],
                    requirements=[lambda x: x.islower()],
                ),
            ),
        ]
        ...
        for data, field in valid_test_fields:
            base_configuration.BaseConfiguration.validate_field(
                field=field, data=data, level="test"
            )
...
def get_suite():
    model_tests = ["test_validate_field"]
